...
sudo docker run --gpus all --privileged --name DOCKER_2204_MNT -e DISPLAY=unix$DISPLAY -e='QT_X11_NO_MITSHM=1' -e IS_PERSISTENT=TRUE -e ANONYMIZED_TELEMETRY=TRUE --ipc=host -it -d --net=host -v /mnt/hdd2/workspace:/content/workspace -v /dev/snd:/dev/snd --volume='/docker_job:/docker_job' --volume='/tmp/.X11-unix:/tmp/.X11-unix' -v /mnt/hdd2/root:/root rssaem_llm:20250520
